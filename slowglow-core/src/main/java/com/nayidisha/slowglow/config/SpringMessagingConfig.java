...
@Configuration
@PropertySource("classpath:spring-messaging.properties")
@EnableIntegration
public class SpringMessagingConfig {
     ...
     * 
     * preReceive applies only if the channel is pollable. It’s invoked when a
     ...
     * 
     * postReceive, like preReceive, applies only to pollable channels. It’s
     * invoked after a message is read from a channel but before it’s returned
